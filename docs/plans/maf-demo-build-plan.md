## Plan: Standalone MAF Demo Chat App
...
4. Phase 4 - Tool Registry and Dummy Tools (*parallel with 5 after 2; consumed by 3 and 6*)
...
5. Phase 5 - Cosmos Persistence + Azure AI Search RAG (*parallel with 4 after 2; consumed by 6*)
...
6. Phase 6 - SSE-first Chat API + Minimal UI (*depends on 3, 4, 5*)
...
7. Phase 7 - Azure Infrastructure in /infra (*depends on 1; can be built in parallel with 2-6 but validated after app config is fixed*)
...
8. Phase 8 - Verification and Demo Readiness (*depends on 6 and 7*)
